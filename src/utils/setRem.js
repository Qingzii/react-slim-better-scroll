...
function setRem() {
  ...
  if (!/Android|webOS|iPhone|iPod|BlackBerry/i.test(navigator.userAgent)) {
    ...
    store.setGlobalHeight(height)
    return
  }
  const baseSize = 30 //设置rem函数
...
window.addEventListener('resize', setRem) // 改变窗口大小时重新设置rem
/* document.addEventListener('gesturestart', function (e) {//阻止双指放大
      e.preventDefault();
  }); */
;(function rotate() {
